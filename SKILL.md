...
This skill helps Hermes agents work with the Toss Securities Open API safely and programmatically. It covers authentication, account header requirements, read-only data access, approval-gated order flows, rate limits, and operational pitfalls such as IP allowlisting.
